...
module.exports = hexa = async (hexa, mek) => {
	try {
		...
		const time = moment.tz('Asia/Jakarta').format('DD/MM HH:mm:ss')
                ...
                const cmd = mek.message.conversation || mek.message[type].caption || mek.message[type].text || (type == 'listResponseMessage') && mek.message[type].singleSelectReply.selectedRowId || (type == 'buttonsResponseMessage') && mek.message[type].selectedButtonId || ''.slice(1).trim().split(/ +/).shift().toLowerCase()
